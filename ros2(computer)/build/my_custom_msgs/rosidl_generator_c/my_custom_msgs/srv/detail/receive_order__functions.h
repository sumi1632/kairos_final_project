...
#ifndef MY_CUSTOM_MSGS__SRV__DETAIL__RECEIVE_ORDER__FUNCTIONS_H_
#define MY_CUSTOM_MSGS__SRV__DETAIL__RECEIVE_ORDER__FUNCTIONS_H_
 ...
 * calls
 * my_custom_msgs__srv__ReceiveOrder_Request__init().
...
/**
 * It calls
 * my_custom_msgs__srv__ReceiveOrder_Request__fini()
 ...
 * my_custom_msgs__srv__ReceiveOrder_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * my_custom_msgs__srv__ReceiveOrder_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_custom_msgs__srv__ReceiveOrder_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_custom_msgs
...
/**
 * It calls
 * my_custom_msgs__srv__ReceiveOrder_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * my_custom_msgs__srv__ReceiveOrder_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_custom_msgs
...
/**
 * It calls
 * my_custom_msgs__srv__ReceiveOrder_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_CUSTOM_MSGS__SRV__DETAIL__RECEIVE_ORDER__FUNCTIONS_H_
