...
#include "my_custom_msgs/srv/detail/receive_order__rosidl_typesupport_fastrtps_c.h"
...
using _ReceiveOrder_Request__ros_msg_type = my_custom_msgs__srv__ReceiveOrder_Request;
...
size_t get_serialized_size_my_custom_msgs__srv__ReceiveOrder_Request(
  const void * untyped_ros_message,
...
static uint32_t _ReceiveOrder_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_msgs__srv__ReceiveOrder_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_msgs
size_t max_serialized_size_my_custom_msgs__srv__ReceiveOrder_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_msgs__srv__ReceiveOrder_Request;
    is_plain =
      (
...
static size_t _ReceiveOrder_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_msgs__srv__ReceiveOrder_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, srv, ReceiveOrder_Request)() {
...
#include "my_custom_msgs/msg/detail/order_detail__functions.h"  // details

// forward declare type support functions
size_t get_serialized_size_my_custom_msgs__msg__OrderDetail(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_my_custom_msgs__msg__OrderDetail(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, msg, OrderDetail)();


using _ReceiveOrder_Response__ros_msg_type = my_custom_msgs__srv__ReceiveOrder_Response;
  ...
  // Field name: details
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_custom_msgs, msg, OrderDetail
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: details
  {
    ...
    if (ros_message->details.data) {
      my_custom_msgs__msg__OrderDetail__Sequence__fini(&ros_message->details);
    }
    if (!my_custom_msgs__msg__OrderDetail__Sequence__init(&ros_message->details, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_msgs
size_t get_serialized_size_my_custom_msgs__srv__ReceiveOrder_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReceiveOrder_Response__ros_msg_type * ros_message = static_cast<const _ReceiveOrder_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name details
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_custom_msgs__msg__OrderDetail(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_msgs__srv__ReceiveOrder_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_msgs
size_t max_serialized_size_my_custom_msgs__srv__ReceiveOrder_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: details
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_custom_msgs__msg__OrderDetail(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_custom_msgs__srv__ReceiveOrder_Response;
    is_plain =
      (
...
static size_t _ReceiveOrder_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_msgs__srv__ReceiveOrder_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, srv, ReceiveOrder_Response)() {
...
// already included above
// #include "my_custom_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_custom_msgs/srv/receive_order.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, srv, ReceiveOrder)() {
