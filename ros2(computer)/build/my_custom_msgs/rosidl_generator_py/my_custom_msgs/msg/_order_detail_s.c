...
bool my_custom_msgs__msg__order_detail__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_custom_msgs.msg._order_detail.OrderDetail", full_classname_dest, 44) == 0);
  }
  my_custom_msgs__msg__OrderDetail * ros_message = _ros_message;
  {  // order_detail_id
...
PyObject * my_custom_msgs__msg__order_detail__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_custom_msgs.msg._order_detail");
