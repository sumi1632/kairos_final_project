...
static const _ReceiveOrder_Request_type_support_symbol_names_t _ReceiveOrder_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, srv, ReceiveOrder_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_custom_msgs, srv, ReceiveOrder_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_custom_msgs, srv, ReceiveOrder_Request)() {
  return &::my_custom_msgs::srv::rosidl_typesupport_c::ReceiveOrder_Request_message_type_support_handle;
}
...
static const _ReceiveOrder_Response_type_support_symbol_names_t _ReceiveOrder_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, srv, ReceiveOrder_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_custom_msgs, srv, ReceiveOrder_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_custom_msgs, srv, ReceiveOrder_Response)() {
  return &::my_custom_msgs::srv::rosidl_typesupport_c::ReceiveOrder_Response_message_type_support_handle;
}
...
static const _ReceiveOrder_type_support_symbol_names_t _ReceiveOrder_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_msgs, srv, ReceiveOrder)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_custom_msgs, srv, ReceiveOrder)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_custom_msgs, srv, ReceiveOrder)() {
  return &::my_custom_msgs::srv::rosidl_typesupport_c::ReceiveOrder_service_type_support_handle;
}
