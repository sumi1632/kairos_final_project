...
#ifndef MY_CUSTOM_MSGS__MSG__DETAIL__ORDER_DETAIL__TRAITS_HPP_
#define MY_CUSTOM_MSGS__MSG__DETAIL__ORDER_DETAIL__TRAITS_HPP_
...
inline void to_yaml(
  const my_custom_msgs::msg::OrderDetail & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const my_custom_msgs::msg::OrderDetail & msg)
{
  return my_custom_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<my_custom_msgs::msg::OrderDetail>()
{
  return "my_custom_msgs::msg::OrderDetail";
}

template<>
inline const char * name<my_custom_msgs::msg::OrderDetail>()
{
  return "my_custom_msgs/msg/OrderDetail";
}

template<>
struct has_fixed_size<my_custom_msgs::msg::OrderDetail>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<my_custom_msgs::msg::OrderDetail>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<my_custom_msgs::msg::OrderDetail>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MY_CUSTOM_MSGS__MSG__DETAIL__ORDER_DETAIL__TRAITS_HPP_
