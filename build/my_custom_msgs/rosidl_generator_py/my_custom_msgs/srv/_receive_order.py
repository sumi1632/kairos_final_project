...
class Metaclass_ReceiveOrder_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_custom_msgs.msg import OrderDetail
...
class ReceiveOrder_Response(metaclass=Metaclass_ReceiveOrder_Response):
    ...
    _fields_and_field_types = {
        'details': 'sequence<my_custom_msgs/OrderDetail>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['my_custom_msgs', 'msg'], 'OrderDetail')),  # noqa: E501
    )
...
class Metaclass_ReceiveOrder(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_custom_msgs.srv.ReceiveOrder')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_custom_msgs.srv import _receive_order
...
class ReceiveOrder(metaclass=Metaclass_ReceiveOrder):
    from my_custom_msgs.srv._receive_order import ReceiveOrder_Request as Request
    from my_custom_msgs.srv._receive_order import ReceiveOrder_Response as Response
