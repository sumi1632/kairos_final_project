...
#include "my_custom_msgs/msg/detail/order_detail__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_custom_msgs::msg::OrderDetail & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_custom_msgs::msg::OrderDetail & ros_message)
{
  // Member: order_detail_id
  cdr >> ros_message.order_detail_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_msgs::msg::OrderDetail;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_custom_msgs::msg::OrderDetail *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_custom_msgs::msg::OrderDetail *>(
    untyped_ros_message);
...
{
  return &my_custom_msgs::msg::typesupport_fastrtps_cpp::_OrderDetail__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_msgs, msg, OrderDetail)() {
  return &my_custom_msgs::msg::typesupport_fastrtps_cpp::_OrderDetail__handle;
}
