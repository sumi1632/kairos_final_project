...
#include "my_custom_msgs/msg/detail/update_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_msgs::msg::UpdateStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_custom_msgs::msg::UpdateStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_custom_msgs::msg::UpdateStatus *>(
    untyped_ros_message);
...
{
  return &my_custom_msgs::msg::typesupport_fastrtps_cpp::_UpdateStatus__handle;
}
