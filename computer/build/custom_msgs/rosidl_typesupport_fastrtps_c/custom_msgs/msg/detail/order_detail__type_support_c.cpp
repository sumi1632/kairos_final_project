...
#include "custom_msgs/msg/detail/order_detail__rosidl_typesupport_fastrtps_c.h"
...
using _OrderDetail__ros_msg_type = custom_msgs__msg__OrderDetail;
...
static uint32_t _OrderDetail__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__OrderDetail(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__OrderDetail;
    is_plain =
      (
...
static size_t _OrderDetail__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__OrderDetail(
