...
#include "custom_msgs/srv/detail/receive_order__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::srv::ReceiveOrder_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::srv::ReceiveOrder_Request & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::srv::ReceiveOrder_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::srv::ReceiveOrder_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::srv::ReceiveOrder_Request *>(
    untyped_ros_message);
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_ReceiveOrder_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, ReceiveOrder_Request)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_ReceiveOrder_Request__handle;
}
...
{
bool cdr_serialize(
  const custom_msgs::msg::OrderDetail &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::OrderDetail &);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
cdr_serialize(
  const custom_msgs::srv::ReceiveOrder_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: details
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::srv::ReceiveOrder_Response & ros_message)
{
  // Member: details
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: details
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OrderDetail(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msgs::srv::ReceiveOrder_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::srv::ReceiveOrder_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msgs::srv::ReceiveOrder_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_ReceiveOrder_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, ReceiveOrder_Response)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_ReceiveOrder_Response__handle;
}
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_ReceiveOrder__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, ReceiveOrder)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_ReceiveOrder__handle;
}
