...
{
  new (message_memory) custom_msgs::msg::OrderDetail(_init);
}

void OrderDetail_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::OrderDetail *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OrderDetail_message_member_array[3] = {
  {
    ...
    offsetof(custom_msgs::msg::OrderDetail, order_detail_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::OrderDetail, menu_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::OrderDetail, table_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OrderDetail_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_msgs::msg::OrderDetail),
...
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::OrderDetail_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, OrderDetail)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::OrderDetail_message_type_support_handle;
}
