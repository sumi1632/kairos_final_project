...
class OrderDetail(metaclass=Metaclass_OrderDetail):
    ...
    def __init__(self, **kwargs):
        ...
        self.order_detail_id = kwargs.get('order_detail_id', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.order_detail_id != other.order_detail_id:
            return False
    ...
    def order_detail_id(self, value):
        if __debug__:
            assert \
                ...
                "The 'order_detail_id' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'order_detail_id' field must be an unsigned integer in [0, 4294967295]"
    ...
    def table_num(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'table_num' field must be an unsigned integer in [0, 4294967295]"
