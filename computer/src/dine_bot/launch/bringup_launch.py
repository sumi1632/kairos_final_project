...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(project_dir, 'params', 'nav2_params.yaml'),
	...
	'urdf_file',
	default_value=os.path.join(project_dir, 'urdf', 'myAGV.urdf'),
	description='Full path to the URDF file to publish')
